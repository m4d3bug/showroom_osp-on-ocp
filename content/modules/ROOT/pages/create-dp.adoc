...
virt-customize -a rhel9-guest.qcow2 --run-command 'systemctl enable chronyd'
virt-customize -a rhel9-guest.qcow2 --run-command 'systemctl disable cloud-init'
virt-customize -a /var/lib/libvirt/images/rhel9-guest.qcow2 --ssh-inject root:file:/root/.ssh/id_rsa.pub
virt-customize -a /var/lib/libvirt/images/rhel9-guest.qcow2 --selinux-relabel
qemu-img create -f qcow2 -F qcow2 -b /var/lib/libvirt/images/rhel9-guest.qcow2 /var/lib/libvirt/images/osp-compute-0.qcow2
virt-install --import --virt-type kvm --ram 16384 --vcpus 4 --cpu=host-passthrough --os-variant rhel8.4 --disk path=/var/lib/libvirt/images/osp-compute-0.qcow2,device=disk,bus=virtio,format=qcow2 --network network:ocp4-provisioning --network network:ocp4-net --boot hd,network --noautoconsole --vnc --name osp-compute0 --noreboot
...
Modified the edpm_container_registry_logins part with a available username and password for the registry.
[source,bash,role=execute]
----
vim osp-ng-dataplane-node-set-deploy.yaml +`cat -n osp-ng-dataplane-node-set-deploy.yaml |grep "edpm_container_registry_logins" |awk '{print $1}'`
----
